...
//    return  result;
    ...
    NSDateComponents *beginComponents = [[NSCalendar currentCalendar] components:NSDayCalendarUnit | NSMonthCalendarUnit | NSYearCalendarUnit fromDate:beginDate];
    
    NSDate *endDate= [NSDate date];
    NSDateComponents *endComponents = [[NSCalendar currentCalendar] components:NSDayCalendarUnit | NSMonthCalendarUnit | NSYearCalendarUnit fromDate:endDate];
    ...
    NSDate *fromDate;
    NSDate *toDate;
    [gregorian rangeOfUnit:NSDayCalendarUnit startDate:&fromDate interval:NULL forDate:[dateFormatter dateFromString:dateString]];
...
//    NSLog(@"beginDateStr：%@---endDateStr：%@",beginDateStr,endDateStr);
    NSDateFormatter *date=[[NSDateFormatter alloc] init];
